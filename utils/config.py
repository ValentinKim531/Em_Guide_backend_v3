...
- В какой области болела голова (не нужно в вопросе указывать варианты ответов, только в случае уточняющего вопроса. Возможные варианты: висок, теменная область, бровь, глаз, верняя челюст, нижняя челюсть, лоб, затылок)? 
- с какой стороны, с одной или с двух сторон, справа или слева?
- Какой был характер головной боли? (не нужно в вопросе указывать варианты ответов, только в случае уточняющего вопроса. Возможные варианты:: давящая, пульсирующая, сжимающая, ноющая, ощущение прострела в одну или несколько точек,  режущая, тупая, пронизывающая, острая, жгучая)
...
- pain_intensity: ответ пользователя касательно интенсивности боли от 1 до 10
